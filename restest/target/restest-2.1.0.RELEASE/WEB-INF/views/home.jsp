                            ...
                            <div class="card-body no-padding">
                                <div role="tabpanel">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li role="presentation" class="active"><a href="#urlRetriever"
                                                                                  aria-controls="urlRetriever"
                                                                                  role="tab"
                                                                                  data-toggle="tab">General</a>
                                        </li>
                                        <li role="presentation"><a href="#test"
                                                                   aria-controls="test"
                                                                   role="tab"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    <div class="radio3 radio-check radio-inline">
                                                                        <input type="radio" id="radio1" name="optionGET"
                                                                               value="option1"
                                                                               checked>
                                                                        <label for="radio1">
                                                                            GET
                                                                    ...
                                                                    <div class="radio3 radio-check radio-inline">
                                                                        <input type="radio" id="radio3"
                                                                               name="optionUPDATE" value="option3"
                                                                               disabled>
                                                                        <label for="radio3">
                                                                            UPDATE
                                                                        </label>
                                                                    ...
                                                                    <div class="radio3 radio-check radio-inline">
                                                                        <input type="radio" id="radio4"
                                                                               name="optionDELELTE" value="option4"
                                                                               disabled>
                                                                        <label for="radio4">
                                                                            DELETE
                                                                        </label>
                                                                ...
                                                                <input id="submit" class="btn btn-success pull-right"
                                                                       type="submit"
                                                                       value="Submit">
                                                            </div>
                                                        </form>
                                                    ...
                                                    <div class="card-body">
                                                        <c:choose>
                                                            <c:when test="${responseValues.getResponseCode().startsWith('1')}">
                                                                <h1>Code: <h2><span class="btn-primary"><c:out value="${responseValues.getResponseCode()}"/></span></h2></h1>
                                                            </c:when>
                                                            <c:when test="${responseValues.getResponseCode().startsWith('2')}">
                                                                <h1>Code: <h2><span class="btn-success"><c:out value="${responseValues.getResponseCode()}"/></span></h2></h1>
                                                            </c:when>
                                                            <c:when test="${responseValues.getResponseCode().startsWith('3')}">
                                                                <h1>Code: <h2><span class="btn-info"><c:out value="${responseValues.getResponseCode()}"/></span></h2></h1>
                                                            </c:when>
                                                            <c:when test="${responseValues.getResponseCode().startsWith('4')}">
                                                                <h1>Code: <h2><span class="btn-danger"><c:out value="${responseValues.getResponseCode()}"/></span></h2></h1>
                                                            </c:when>
                                                            ...
                                                            <div role="tabpanel">
                                                                ...
                                                                <div class="tab-content">
                                                                    <div role="tabpanel" class="tab-pane active"
                                                                         id="responseHeaders">
                                                                        <c:forEach items="${responseHeaders}"
                                                                                   var="entry">
                                                                            <ul>
                                                                                <li>
                                                                                    <b><c:out
                                                                    ...
                                                                    <div role="tabpanel" class="tab-pane"
                                                                         id="requestHeaders">
                                                                        <c:forEach items="${requestHeaders}"
                                                                                   var="entry">
                                                                            <ul>
                                                                                <li>
                                                                                    <b><c:out
                                                    ...
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <div class="card-title">
                                                                <div class="title">General Info
                                                                    <small> (<c:out value="${generalInfo.size()}"/>)
                                                                    </small>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="card-body">
                                                            <c:forEach items="${generalInfo}" var="entry">
                                                                <ul>
                                                                    <li><b><c:out value="${entry.key}: "/> </b> <c:out
                                                                            value="${entry.value}"/>
                                                                    </li>
                                                                </ul>
                                                            </c:forEach>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="test">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="text-center"><h2 id="urlTest"><c:out value="${url}"></c:out></h2></div>
                                                            <ul>
